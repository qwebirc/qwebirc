...
qwebirc.config.DEFAULT_OPTIONS = [
  ...
  [16, "STYLE_SAT", "Adjust user interface saturation", function(ui) {
    return {class_: qwebirc.config.SaturationOption, default_: ui.__styleValues.saturation};
  }, {
    applyChanges: function(value, ui) {
      ui.setModifiableStylesheetValues({saturation: value});
    }
  }],
  [17, "STYLE_LIGHTNESS", "Adjust user interface lightness", function(ui) {
    return {class_: qwebirc.config.LightnessOption, default_: ui.__styleValues.lightness};
  }, {
    applyChanges: function(value, ui) {
      ui.setModifiableStylesheetValues({lightness: value});
    }
  }],
